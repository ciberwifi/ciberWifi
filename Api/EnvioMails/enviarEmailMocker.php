...
$costo="1390";
$link='https://mpago.la/1GpeQdn';
$email='tigra.gata89@gmail.com';
$apellidoynombre= "Prueba Maria Gimenez";
...
try {
    ...
    $mail->Subject = '-De CiberWifi- Link de Pago Enero 2022';
    $mail->isHTML(true);
    $mail->Body = '
...
<h3>Su Servicio se encuentra vencido</h3>
