...
<h4 style="margin-bottom: 30px; margin-left: -5%;">Retiros y Recupero</h4>

<span class="border-bottom"></span>

  
<div class="mb-3" style="max-width: 480px;">
  <label for="formFile" class="form-label">Ingresar Retiros por Lote</label>
  <input class="form-control" type="file" id="formFile">
 
</div>
 <td>
  <button type="button" class="btn btn-success btn-sm" id="btningresarretiro"  data-bs-toggle="contenedorBajas" data-bs-target="#contenedorReclamo">Ingresar</button>
  </td>
      ...
      <div class="table-responsive"  style="margin-top:5%;margin-left: -3%;">
        ...
        <table id="tablaRetiros" class="table table-striped table-sm  align-middle" >
            <?php
        $bajas = $entityManager->getRepository('Bajas')->findBy(array('estado' => 'retiro'));
