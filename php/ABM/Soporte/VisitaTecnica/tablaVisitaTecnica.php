...
<td>
   ...
   <div id="contenedorVt" class="container" style="margin-top: 20px;" >
...
<script>
 ...
 $("#btnhistorialvt").click(function(){

      var loadUrl = "php/ABM/Soporte/VisitaTecnica/tablaVisitaTecnicaHistorial.php"; // paso parametro accion e id
      $("#contenedorVt").load(loadUrl); // ejecuto
      }); 
 ...
 $('#tablavisitastecnicas').find('tr').click(function(){
   var row = $(this).find('td:first').text();
       ...
       var loadUrl = "php/ABM/Soporte/VisitaTecnica/asignarFechaVT.php";
        var data= { 'id' : row };
       ...
       var loadUrl = "php/ABM/Soporte/VisitaTecnica/editarFechaVT.php";
        var data= { 'id' : row };
          $.post(loadUrl, data ,function(result) { 
          $("#resultadovt").html(result);
          });
       ...
       var loadUrl = "php/ABM/Soporte/VisitaTecnica/visitaRealizada.php";
        var data= { 'id' : row };
          $.post(loadUrl, data ,function(result) { 
          $("#resultadovt").html(result);
          });
